...
def main() -> int:
    ...
    if args.command == "summary":
        ...
        print(
            format_tiny_live_live_authorization_preview_json(
                build_tiny_live_live_authorization_preview(
                    log_dir=args.log_dir,
                    record_authorization_preview=args.record_authorization_preview,
                    confirm_tiny_live_live_authorization_preview=args.confirm_tiny_live_live_authorization_preview,
                )
            )
        )
    ...
    elif args.command == "tiny-live-lane-arm-preview":
        from src.app.hammer_radar.operator.tiny_live_lane_arm_preview import (
            build_tiny_live_lane_arm_preview,
            format_tiny_live_lane_arm_preview_json,
        )
        ...
        print(
            format_tiny_live_lane_arm_preview_json(
                build_tiny_live_lane_arm_preview(
                    log_dir=args.log_dir,
                    record_lane_arm_preview=args.record_lane_arm_preview,
                    confirm_tiny_live_lane_arm_preview=args.confirm_tiny_live_lane_arm_preview,
                )
            )
        )
        ...
        print(
            format_tiny_live_order_payload_preview_json(
                build_tiny_live_order_payload_preview(
                    log_dir=args.log_dir,
                    record_order_payload_preview=args.record_order_payload_preview,
                    confirm_tiny_live_order_payload_preview=(
                        args.confirm_tiny_live_order_payload_preview
                    ),
                )
            )
        )
    elif args.command == "tiny-live-order-payload-write-gate":
        from src.app.hammer_radar.operator.tiny_live_order_payload_write_gate import (
            build_tiny_live_order_payload_write_gate,
            format_tiny_live_order_payload_write_gate_json,
        )
        ...
        print(
            format_tiny_live_order_payload_write_gate_json(
                build_tiny_live_order_payload_write_gate(
                    log_dir=args.log_dir,
                    write_order_payload=args.write_order_payload,
                    confirm_tiny_live_order_payload_write=(
                        args.confirm_tiny_live_order_payload_write
                    ),
                )
            )
        )
        ...
        from src.app.hammer_radar.operator.tiny_live_binance_autonomous_readiness_binding import (
            ...
            format_binance_autonomous_readiness_binding_json,
        )
    ...
    elif args.command == "tiny-live-post-manual-leverage-margin-verification":
        from src.app.hammer_radar.operator.tiny_live_leverage_margin_readiness import (
            build_post_manual_leverage_margin_alignment_verification,
            format_post_manual_leverage_margin_verification_json,
        )
        ...
        print(
            format_tiny_live_fresh_trigger_watch_json(
                build_tiny_live_fresh_trigger_watch(
                    ...
                    load_discovered_binance_readonly_env=args.load_discovered_binance_readonly_env,
                    binance_readonly_env_file=args.binance_readonly_env_file,
                    record_trigger_watch=args.record_trigger_watch,
                    operator_id=args.operator_id,
                    reason=args.reason,
                    send_telegram=str(args.send_telegram).lower() == "true",
                )
            )
        )
    ...
    elif args.command == "tiny-live-autonomous-trigger-scheduler-activation-readiness":
        from src.app.hammer_radar.operator.tiny_live_autonomous_trigger_scheduler_activation_readiness import (
            ...
            format_autonomous_trigger_scheduler_activation_readiness_json,
        )
    ...
    elif args.command == "tiny-live-autonomous-trigger-scheduler-timer-health":
        from src.app.hammer_radar.operator.tiny_live_autonomous_trigger_scheduler_timer_health import (
            ...
            format_autonomous_trigger_scheduler_timer_health_json,
        )
    ...
    elif args.command == "tiny-live-real-candidate-dry-run-trigger-bridge":
        from src.app.hammer_radar.operator.tiny_live_real_candidate_dry_run_trigger_bridge import (
            ...
            format_tiny_live_real_candidate_dry_run_trigger_bridge_json,
        )
            ...
            format_tiny_live_real_candidate_dry_run_trigger_bridge_json(
                build_tiny_live_real_candidate_dry_run_trigger_bridge(
                    ...
                    record_real_candidate_dry_run_trigger_bridge=(
                        args.record_real_candidate_dry_run_trigger_bridge
                    ),
                )
            )
        )
    ...
    elif args.command == "tiny-live-signed-request-with-credentials-drill":
        from src.app.hammer_radar.operator.tiny_live_signed_request_with_credentials_drill import (
            ...
            format_tiny_live_signed_request_with_credentials_drill_json,
        )
            ...
            format_tiny_live_signed_request_with_credentials_drill_json(
                build_tiny_live_signed_request_with_credentials_drill(
                    ...
                    write_signed_request_with_credentials=(
                        args.write_signed_request_with_credentials
                    ),
                    confirm_tiny_live_signed_request_with_credentials=(
                        args.confirm_tiny_live_signed_request_with_credentials
                    ),
                )
            )
        )
    ...
    elif args.command == "expansion-risk-contract-write-gate-preview":
    ...
    elif args.command == "multi-lane-dry-run-timer-install-gate":
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    tiny_live_live_authorization_preview_parser = subparsers.add_parser(
    ...
    tiny_live_lane_arm_preview_parser = subparsers.add_parser(
    ...
    tiny_live_order_payload_preview_parser = subparsers.add_parser(
        "tiny-live-order-payload-preview",
        parents=[parent],
    )
    tiny_live_order_payload_preview_parser.add_argument(
        "--record-order-payload-preview",
        action="store_true",
    )
    tiny_live_order_payload_preview_parser.add_argument(
        "--confirm-tiny-live-order-payload-preview",
        default=None,
    )

    tiny_live_order_payload_write_gate_parser = subparsers.add_parser(
    ...
    tiny_live_post_manual_leverage_margin_verification_parser = subparsers.add_parser(
    ...
    tiny_live_fresh_trigger_watch_parser = subparsers.add_parser(
        "tiny-live-fresh-trigger-watch",
        parents=[parent],
    )
    tiny_live_fresh_trigger_watch_parser.add_argument(
        "--load-discovered-binance-readonly-env",
        action="store_true",
    )
    tiny_live_fresh_trigger_watch_parser.add_argument(
    ...
    tiny_live_real_candidate_dry_run_trigger_bridge_parser = subparsers.add_parser(
    ...
    tiny_live_signed_request_with_credentials_drill_parser = subparsers.add_parser(
    ...
    strategy_lab_evidence_adapter_pack_parser = subparsers.add_parser(
        "strategy-lab-evidence-adapter-pack",
        parents=[parent],
    )
    strategy_lab_evidence_adapter_pack_parser.add_argument("--no-write", action="store_true")
    strategy_lab_evidence_adapter_pack_parser.add_argument(
        "--adapter",
        choices=(
            "all",
            "near_miss_13m",
    ...
    expansion_risk_contract_write_gate_preview_parser = subparsers.add_parser(
    ...
    multi_lane_dry_run_timer_install_gate_parser = subparsers.add_parser(
