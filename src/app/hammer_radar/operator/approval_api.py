...
@app.get("/tiny-live/autonomous-trigger-scheduler/activation-readiness")
def tiny_live_autonomous_trigger_scheduler_activation_readiness() -> dict:
    return build_autonomous_trigger_scheduler_activation_readiness()
...
@app.get("/tiny-live/real-candidate-timer-observation-certificate/status")
def tiny_live_real_candidate_timer_observation_certificate_status(
    lane_key: str | None = None,
) -> dict:
...
@app.get("/tiny-live/manual-operator-dry-run-arming-post-arm-certificate/status")
def tiny_live_manual_operator_dry_run_arming_post_arm_certificate_status(
    lane_key: str | None = None,
) -> dict:
    return build_status_tiny_live_manual_operator_dry_run_arming_post_arm_certificate(
        log_dir=get_log_dir(use_env=True),
        lane_key=lane_key,
    )


@app.get("/tiny-live/armed-dry-run-timer-observation-certificate/status")
def tiny_live_armed_dry_run_timer_observation_certificate_status(
    lane_key: str | None = None,
) -> dict:
